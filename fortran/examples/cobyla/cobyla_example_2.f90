...
if(abs(f - (-0.0000000000000000_RP)) > 10e-12_RP) error stop
if(abs(cstrv - 7.0000000000000000_RP) > 10e-12_RP) error stop
if(any(abs(x_hexagon-2.0_RP) > 10e-10_RP)) error stop
