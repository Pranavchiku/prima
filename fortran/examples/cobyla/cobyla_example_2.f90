...
if(abs(f - (-0.86602541468304584_RP)) > 10e-15_RP) error stop
if(abs(cstrv - 1.4312227569757141e-08_RP) > 10e-15_RP) error stop
if(any(abs(x_hexagon - [0.89832144518526202_RP, 1.3560481629085774_RP, &
            ...
            0.91670935062202175_RP]) > 10e-15_RP)) error stop
