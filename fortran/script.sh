...
$FC --cpp -c ./tests/$test_name -I../build/fortran -I./ -I../build/fortran/mod
$FC --cpp -DPRIMA_DEBUGGING=0 -DPRIMA_AGGRESSIVE_OPTIONS=0 -DPRIMA_INTEGER_KIND=4 -DPRIMA_REAL_PRECISION=32 -DPRIMA_QP_AVAILABLE=0 -DPRIMA_TESTDIM="'small'" ./tests/test.F90 -I../build/fortran -I./ -I../build/fortran/mod
